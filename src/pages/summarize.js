...
class SummarizePage extends React.Component {
  constructor(props) {
    super(props);
  ...
  submitHandler = (e) => {
    ...
    const firstExampleSummary = this.state.firstExampleSummary
    const firstExampleText = this.state.firstExampleText
    const secondExampleSummary = this.state.secondExampleSummary
    const secondExampleText = this.state.secondExampleText
    const textToSummarize = this.state.textToSummarize
    ...
    const requestBody = {
        ...
        firstExampleSummary: firstExampleSummary,
        firstExampleText: firstExampleText,
        secondExampleSummary: secondExampleSummary,
        secondExampleText: secondExampleText,
        textToSummarize: textToSummarize
        // property: "NWA Daily"
      }
      console.log(firstExampleText)
      console.log(firstExampleSummary)
      console.log(secondExampleText)
      console.log(secondExampleSummary)
      console.log(textToSummarize)
      fetch(`https://shielded-beach-96017.herokuapp.com/api/gpt`, {
      mode: "cors",
      method: 'POST',
      ...
      <form class="uk-form" style={{marginLeft:"auto",marginRight:"auto",width:"75%"}}>
              ...
              {this.state.isSubmitted === false ?
                (
                  <div class="uk-margin">
              <label>
              First example to summarize
              </label>
              <br></br>
              {(typeof window !== 'undefined' && ReactQuill) ? 
                (
              <ReactQuill theme="snow" 
                  name="firstExampleText"
                  value={this.state.firstExampleText}
                  onChange={(content) => {
                  this.setState({firstExampleText:content})
                  }}
              />
                )
                :
              ...
              {(typeof window !== 'undefined' && ReactQuill) ? 
                (
              <ReactQuill theme="snow" 
                  name="firstExampleSummary"
                  value={this.state.firstExampleSummary}
                  onChange={(content) => {
                    console.log(content)
                  this.setState({firstExampleSummary:content})
                  }}
              />
                )
                :
              ...
              <br></br>
              <label>
              Second Example to Summarize
              </label>
              <br></br>
              {(typeof window !== 'undefined' && ReactQuill) ? 
                (
              <ReactQuill theme="snow" 
                  name="secondExampleText"
                  value={this.state.secondExampleText}
                  onChange={(content) => {
                  this.setState({secondExampleText:content})
                  }}
              />
                )
                :
              ...
              {(typeof window !== 'undefined' && ReactQuill) ? 
                (
              <ReactQuill theme="snow" 
                  name="secondExampleSummary"
                  value={this.state.secondExampleSummary}
                  onChange={(content) => {
                  this.setState({secondExampleSummary:content})
                  }}
              />
                )
                :
                ...
                <br></br>
                <label>
              Text You're Wanting To Summarize Now
              </label>
              <br></br>
              {(typeof window !== 'undefined' && ReactQuill) ? 
                (
              <ReactQuill theme="snow" 
                  ...
                  onChange={(content) => {
                  this.setState({textToSummarize:content})
                  }}
              />
                )
                :
            ...
            <div dangerouslySetInnerHTML={{__html:this.state.summary.summary}}></div>
...
export default withBreakpoints(SummarizePage);
