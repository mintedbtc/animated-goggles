...
<Dialog
      ...
      <h2 className="job-header">Browse our Northwest Arkansas Partners</h2>
      <a href="/partnerpost">
...
{data.allStrapiPartner.edges.length > 0 ?
(breakpoints.sm ? 
(
<div className="uk-section">
      {/* <h1 className="uk-text-center">{data.strapiHomepage.hero.title}</h1> */}
        <div className="uk-container uk-container-large" >
          ...
          <PartnersComponent partners={data.allStrapiPartner.edges} />
...
export default withBreakpoints(PartnersPage);
